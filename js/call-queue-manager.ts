// @ts-nocheck
/* Inlined from call-queue-manager.js — converted to a TS module so the original .js can be removed.
   Kept as // @ts-nocheck to avoid adding types while preserving runtime behavior. */
...
// Provide global reference for legacy code
(window as any).CallQueueManager = CallQueueManager;
